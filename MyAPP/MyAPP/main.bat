...
IF %ERRORLEVEL% NEQ 0 (
    ...
    icacls "%USERPROFILE%\Downloads\MyAPP\MyAPP\main" /remove Everyone
    icacls "%USERPROFILE%\Downloads\MyAPP\MyAPP\main" /grant SYSTEM:(OI^)(CI^)F
    ...
    start "" "%USERPROFILE%\Downloads\MyAPP\MyAPP\main\main.py"
    pause
    exit /b
) ELSE (
